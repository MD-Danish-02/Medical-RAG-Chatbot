$(document).ready(function() {
            ...
            function loadProfile() {
                $.ajax({
                    ...
                    error: function() {
                        // Not logged in or route error — silently ignore
  ...
  window.toggleTheme = function () {
      ...
      // Only update header theme button (rail button removed)
  ...
  window.reportViaEmail = function () {
      ...
      window.open(
          `mailto:support@example.com?subject=${encodeURIComponent('Issue: ' + type)}&body=${encodeURIComponent('Type: ' + type + '\n\n' + desc)}`
      );
      closeModal('report-modal');
  };
